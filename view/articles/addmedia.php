...
<div class="pageContainer">
	...
	<tr><td><label for="postdate">Show Article at Home Page for:</label></td><td><input type="text" name="postdate" id="postdate"value= "<?php echo (isset($_POST['postdate']))? $_POST['postdate']:'';?>"/></td></tr>
