...
class AccountController Extends ControllerBase Implements IController
{
	public function Redirect($action, $value)
	{
		...
		switch ($action)
		{
			...
			case 'activate':$this->activate($$value);break;
			case 'forgotpass':$this->forgotPassword();break;
			case 'forgotpassemail':$this->forgotPassEmail($value);break;
			case 'resetpass':$this->resetPassword($$value);break;
